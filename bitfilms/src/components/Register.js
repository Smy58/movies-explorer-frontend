            ...
            <form onSubmit={handleSubmit} className="form form_type_register">
                <fieldset className="form__set">
                    <label className="form__field">Имя
                        <input id="name-input" name="name" className="form__input" type="text" placeholder="Название" onChange={handleChange} required minLength='2' maxLength='30'></input>
                        <span className='form__input-error' id='name-input-error'></span>
                    </label>
                    <label className="form__field">E-mail
                        <input id="email-input" name="email" className="form__input" type="email" placeholder="Email" onChange={handleChange} required></input>
                        <span className='form__input-error' id='email-input-error'></span>
                    </label>
                    <label className="form__field">Пароль
                        <input id="password-input" name="password" className="form__input" type="password" placeholder="Пароль" onChange={handleChange} required></input>
